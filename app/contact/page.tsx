    ...
    <div className="container-balanced py-16">
      ...
      <div className="mb-12 space-y-4">
        ...
        <p className="max-w-3xl text-lg text-text-muted">
          Interested in working with us? We would love to hear about your requirements 
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t border-border">
              ...
              <p className="text-sm text-text-muted mt-1">Small Business</p>
              <p className="text-sm text-text-muted">SAM.gov Registered</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="glass rounded-2xl p-6">
            ...
            <p className="text-sm text-text-muted">
              Request our UEI, CAGE code, and company details for your procurement files.
            </p>
          </div>
